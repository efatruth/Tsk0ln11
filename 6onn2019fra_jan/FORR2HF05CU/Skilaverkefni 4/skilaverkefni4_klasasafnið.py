...
class Grunnskolanemi(Nemi):
    ...
    def __str__(self):
         return "Grunnskolanemi:" "KennitolZ:" + str(self.kennitala) +" heitir "+ self.nafn +" kynlif er: " + self.kyn +" heima: " +self.heimilisfang +" simatala:" + str(self.simanumer) +" simatala:" +(self.netfang)+" forreldra:" +(self.forradamadur)+" skóla:" +(self.nafnSkola)
