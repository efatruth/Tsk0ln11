        ...
        if val == 0:
            ...
            while continue1:
                try:
                    ...
                    time.sleep(1)
                    if sidA > 0: #ef stærra en 0 spurja um lengd skammhliðar
                        sidB = float(input(' Sláðu inn lengd mótlægu skammhliðarinnar: '))
                        time.sleep(1)
                        print('\n Langhliðinn er: ',round(langhlid(sidA,sidB),2))#senda skammhliðar í fallið langhlid() sem skilar langhliðinni
                        time.sleep(1)
                    #eða ef 0 hætta
                    else:
                        continue1 = False
